...
// Main schema for vehicle models - adjusted to handle API response
...
export type CreateVehicleModel = z.infer<typeof createModelSchema>

// Schema for updating a model
export const updateModelSchema = createModelSchema.partial()

// Type for updating a model
export type UpdateVehicleModel = z.infer<typeof updateModelSchema>