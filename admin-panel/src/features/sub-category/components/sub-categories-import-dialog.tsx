...
export function SubCategoriesImportDialog({ open, onOpenChange }: Props) {
  const [isUploading, setIsUploading] = useState(false)
  const { refreshSubCategories } = useSubCategories()
  ...
  return (
    ...
    >
      <DialogContent className='gap-4 sm:max-w-md'>
        ...
        <Form {...form}>
          <form id='sub-categories-import-form' onSubmit={form.handleSubmit(onSubmit)}>
            <FormField
                        ...
                        {isDragActive ? (
                          ...
                          <div>
                            ...
                            <p className="text-xs text-muted-foreground mt-2">
                              Required format: .csv file with columns for sub-category, desc, logo, categoryId, etc.
                            </p>
                          </div>
                        )}
                      </div>
